              ...
              <div class="navbar-collapse collapse navbar-responsive-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                  <li class="dropdown">
                    ...
                    <li><a href="http://localhost/Pluto/admin_allocated_leave.php"><i class="material-icons">assignment</i></i> Allocated Leave</a></li>
					 <li class="divider"></li>
    ...
    <div class="row">
      <div >
        <div class="well bs-component">
			...
			<tbody>
			<?php 
				$sql = "Select leave_id,leave_log.emp_id,name,ltype,date_now,start_date,end_date,days,status from emp_table,leave_log where leave_log.emp_id=emp_table.emp_id";
				$key=0;
...
<td><a href="http://localhost/Pluto/PHP/admin_leave_log_delete.php?emp_id=<?php echo $row['leave_id'];?>" class="btn btn-danger"> Delete</a></td>
			</tr>
				<?php }?>
			</tbody>
			</table>
