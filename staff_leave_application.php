                ...
                <ul class="nav navbar-nav navbar-right">
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
					  ...
					  <li><a href="http://localhost/Pluto/staff_leave_history.php"><i class="material-icons">assignment</i></i> Leave History</a></li>
                      <li class="divider"></li>
      ...
      <div >
        <div class="well bs-component">
			...
			<div class="alert alert-dismissible alert-info">
				...
				<a href="http://localhost/Pluto/staff_home.php" class="alert-link">Ho..<?php echo $row['name'];?>!!</a>, everything alright?
			</div>
