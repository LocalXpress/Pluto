            ...
            <div class="container-fluid">
              <div class="navbar-collapse collapse navbar-responsive-collapse">
                <ul class="nav navbar-nav">
				  ...
				  <b></b></a></li>
				  <li><a href="http://localhost/Pluto/principal_home.php"><b><?php echo $row['name'];?></b></a></li>
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right">
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="http://localhost/Pluto/principal_home.php"><i class="material-icons">assignment</i></i> Home</a></li>
                      <li class="divider"></li>
